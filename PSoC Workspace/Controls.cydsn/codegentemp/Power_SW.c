...
*
* \funcusage
*  \snippet Power_SW_SUT.c usage_Power_SW_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Power_SW_SUT.c usage_Power_SW_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Power_SW_SUT.c usage_Power_SW_Read  
*******************************************************************************/
...
* preferred Power_SW_Read() API because the 
* Power_SW_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Power_SW_SUT.c usage_Power_SW_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Power_SW_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Power_SW_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Power_SW_0_INTR       (First pin in the list)
    *  - Power_SW_1_INTR       (Second pin in the list)
    *  - ...
    *  - Power_SW_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Power_SW_SUT.c usage_Power_SW_SetInterruptMode
    *******************************************************************************/
    void Power_SW_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Power_SW_0_INTR) != 0u) 
		{ 
			 Power_SW_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Power_SW_SUT.c usage_Power_SW_ClearInterrupt
    *******************************************************************************/
