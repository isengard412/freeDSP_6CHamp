...
extern volatile int16 Volume_ADC_offset;
extern volatile int16 Volume_ADC_countsPerVolt; /* Obsolete variable, do not modify in new design */
extern volatile int32 Volume_ADC_countsPer10Volt;
extern volatile int16 Volume_ADC_shift;
...
#define Volume_ADC_MAX_FREQUENCY              (18000000)       /* 18Mhz */

#define Volume_ADC_10V_COUNTS                 (10.0F)
#define Volume_ADC_10MV_COUNTS                (10000)
#define Volume_ADC_10UV_COUNTS                (10000000L)
...
#define Volume_ADC__FREERUNNING 0
#define Volume_ADC__TRIGGERED 1

/*  Extended Sample Mode setting constants */
#define Volume_ADC__FREE_RUNNING 0
#define Volume_ADC__SOFTWARE_TRIGGER 1
#define Volume_ADC__HARDWARE_TRIGGER 2

/*  Clock Source setting constants */
#define Volume_ADC__INTERNAL 1
#define Volume_ADC__EXTERNAL 0
...
#define Volume_ADC_DEFAULT_RESOLUTION     (12u)   /* ADC resolution selected with parameters.*/
#define Volume_ADC_DEFAULT_CONV_MODE      (0u)        /* Default conversion method */
#define Volume_ADC_DEFAULT_INTERNAL_CLK   (1u)             /* Default clock selection */
#define Volume_ADC_DEFAULT_REFERENCE      (0u)         /* Default reference */
#define Volume_ADC_DEFAULT_RANGE          (0u)       /* ADC Input Range selection */
#define Volume_ADC_CLOCK_FREQUENCY        (1600000u)   /* Clock frequency */
#define Volume_ADC_NOMINAL_CLOCK_FREQ     (1600000)  /* Nominal Clock Frequency */
#define Volume_ADC_HIGH_POWER_PULSE       (1u)        /* Not zero when clock pulse > 50 ns */
...
#define Volume_ADC_DEFAULT_REF_VOLTAGE \
                                   (((Volume_ADC_DEFAULT_REFERENCE != (uint8)Volume_ADC__EXT_REF) && \
                                    ((Volume_ADC_DEFAULT_RANGE == (uint8)Volume_ADC__VSSA_TO_VDDA) || \
                                     (Volume_ADC_DEFAULT_RANGE == (uint8)Volume_ADC__VNEG_VDDA_2_DIFF))) ? \
                                     (CYDEV_VDDA / 2) : \
                                   (((Volume_ADC_DEFAULT_REFERENCE != (uint8)Volume_ADC__EXT_REF) && \
                                     (Volume_ADC_DEFAULT_RANGE == (uint8)Volume_ADC__VNEG_VDDA_2_DIFF)) ? \
                                     CYDEV_VDDA : (1.024)))      /* ADC reference voltage. */
#define Volume_ADC_DEFAULT_REF_VOLTAGE_MV \
                                   (((Volume_ADC_DEFAULT_REFERENCE != (uint8)Volume_ADC__EXT_REF) && \
                                    ((Volume_ADC_DEFAULT_RANGE == (uint8)Volume_ADC__VSSA_TO_VDDA) || \
                                     (Volume_ADC_DEFAULT_RANGE == (uint8)Volume_ADC__VNEG_VDDA_2_DIFF))) ? \
                                     (CYDEV_VDDA_MV / 2) : \
...
#define Volume_ADC_DEFAULT_POWER \
       ((Volume_ADC_NOMINAL_CLOCK_FREQ > (Volume_ADC_MAX_FREQUENCY / 4)) ? Volume_ADC__HIGHPOWER : \
       ((Volume_ADC_NOMINAL_CLOCK_FREQ > (Volume_ADC_MAX_FREQUENCY / 8)) ? Volume_ADC__MEDPOWER : \
                                                                                       Volume_ADC__MINPOWER))
/* Constant for a global usage */
/* Number of additional clocks for sampling data*/
#define Volume_ADC_SAMPLE_PRECHARGE       (4u)
...
#define Volume_ADC_SAR_TR0_REG                (* (reg8 *) Volume_ADC_ADC_SAR__TR0 )
#define Volume_ADC_SAR_TR0_PTR                (  (reg8 *) Volume_ADC_ADC_SAR__TR0 )
#define Volume_ADC_SAR_CSR0_REG               (* (reg8 *) Volume_ADC_ADC_SAR__CSR0 )
#define Volume_ADC_SAR_CSR0_PTR               (  (reg8 *) Volume_ADC_ADC_SAR__CSR0 )
#define Volume_ADC_SAR_CSR1_REG               (* (reg8 *) Volume_ADC_ADC_SAR__CSR1 )
#define Volume_ADC_SAR_CSR1_PTR               (  (reg8 *) Volume_ADC_ADC_SAR__CSR1 )
#define Volume_ADC_SAR_CSR2_REG               (* (reg8 *) Volume_ADC_ADC_SAR__CSR2 )
#define Volume_ADC_SAR_CSR2_PTR               (  (reg8 *) Volume_ADC_ADC_SAR__CSR2 )
#define Volume_ADC_SAR_CSR3_REG               (* (reg8 *) Volume_ADC_ADC_SAR__CSR3 )
#define Volume_ADC_SAR_CSR3_PTR               (  (reg8 *) Volume_ADC_ADC_SAR__CSR3 )
#define Volume_ADC_SAR_CSR4_REG               (* (reg8 *) Volume_ADC_ADC_SAR__CSR4 )
#define Volume_ADC_SAR_CSR4_PTR               (  (reg8 *) Volume_ADC_ADC_SAR__CSR4 )
#define Volume_ADC_SAR_CSR5_REG               (* (reg8 *) Volume_ADC_ADC_SAR__CSR5 )
#define Volume_ADC_SAR_CSR5_PTR               (  (reg8 *) Volume_ADC_ADC_SAR__CSR5 )
#define Volume_ADC_SAR_CSR6_REG               (* (reg8 *) Volume_ADC_ADC_SAR__CSR6 )
#define Volume_ADC_SAR_CSR6_PTR               (  (reg8 *) Volume_ADC_ADC_SAR__CSR6 )
#define Volume_ADC_SAR_SW0_REG                (* (reg8 *) Volume_ADC_ADC_SAR__SW0 )
#define Volume_ADC_SAR_SW0_PTR                (  (reg8 *) Volume_ADC_ADC_SAR__SW0 )
#define Volume_ADC_SAR_SW2_REG                (* (reg8 *) Volume_ADC_ADC_SAR__SW2 )
#define Volume_ADC_SAR_SW2_PTR                (  (reg8 *) Volume_ADC_ADC_SAR__SW2 )
#define Volume_ADC_SAR_SW3_REG                (* (reg8 *) Volume_ADC_ADC_SAR__SW3 )
#define Volume_ADC_SAR_SW3_PTR                (  (reg8 *) Volume_ADC_ADC_SAR__SW3 )
#define Volume_ADC_SAR_SW4_REG                (* (reg8 *) Volume_ADC_ADC_SAR__SW4 )
#define Volume_ADC_SAR_SW4_PTR                (  (reg8 *) Volume_ADC_ADC_SAR__SW4 )
#define Volume_ADC_SAR_SW6_REG                (* (reg8 *) Volume_ADC_ADC_SAR__SW6 )
#define Volume_ADC_SAR_SW6_PTR                (  (reg8 *) Volume_ADC_ADC_SAR__SW6 )
#define Volume_ADC_SAR_CLK_REG                (* (reg8 *) Volume_ADC_ADC_SAR__CLK )
#define Volume_ADC_SAR_CLK_PTR                (  (reg8 *) Volume_ADC_ADC_SAR__CLK )
#define Volume_ADC_SAR_WRK0_REG               (* (reg8 *) Volume_ADC_ADC_SAR__WRK0 )
#define Volume_ADC_SAR_WRK0_PTR               (  (reg8 *) Volume_ADC_ADC_SAR__WRK0 )
#define Volume_ADC_SAR_WRK1_REG               (* (reg8 *) Volume_ADC_ADC_SAR__WRK1 )
#define Volume_ADC_SAR_WRK1_PTR               (  (reg8 *) Volume_ADC_ADC_SAR__WRK1 )
#define Volume_ADC_SAR_WRK_PTR                (  (reg16 *) Volume_ADC_ADC_SAR__WRK0 )
#define Volume_ADC_PWRMGR_SAR_REG             (* (reg8 *) Volume_ADC_ADC_SAR__PM_ACT_CFG )
#define Volume_ADC_PWRMGR_SAR_PTR             (  (reg8 *) Volume_ADC_ADC_SAR__PM_ACT_CFG )
#define Volume_ADC_STBY_PWRMGR_SAR_REG        (* (reg8 *) Volume_ADC_ADC_SAR__PM_STBY_CFG )
#define Volume_ADC_STBY_PWRMGR_SAR_PTR        (  (reg8 *) Volume_ADC_ADC_SAR__PM_STBY_CFG )

/* renamed registers for backward compatible */
#define Volume_ADC_SAR_WRK0                   Volume_ADC_SAR_WRK0_REG
#define Volume_ADC_SAR_WRK1                   Volume_ADC_SAR_WRK1_REG
...
#define Volume_ADC_ACT_PWR_SAR_EN             (uint8)(Volume_ADC_ADC_SAR__PM_ACT_MSK)

/* PM_STBY_CFG (Alternate Active Power Mode CFG Register) Power enable mask */
#define Volume_ADC_STBY_PWR_SAR_EN            (uint8)(Volume_ADC_ADC_SAR__PM_STBY_MSK)

/* This is only valid if there is an internal clock */
#if(Volume_ADC_DEFAULT_INTERNAL_CLK)
    /* Power enable mask */
    #define Volume_ADC_ACT_PWR_CLK_EN         (uint8)(Volume_ADC_theACLK__PM_ACT_MSK)
    /* Standby power enable mask */
    #define Volume_ADC_STBY_PWR_CLK_EN        (uint8)(Volume_ADC_theACLK__PM_STBY_MSK)
#endif /*End Volume_ADC_DEFAULT_INTERNAL_CLK */
...
#define Volume_ADC_SAR_CAP_TRIM_MASK          (0x07u)
#define Volume_ADC_SAR_CAP_TRIM_0             (0x00u)    /*decrease attenuation capacitor by 0*/
#define Volume_ADC_SAR_CAP_TRIM_1             (0x01u)    /*decrease by 0.5 LSB*/
#define Volume_ADC_SAR_CAP_TRIM_2             (0x02u)    /*decrease by 2*0.5 LSB = 1 LSB*/
#define Volume_ADC_SAR_CAP_TRIM_3             (0x03u)    /*decrease by 3*0.5 LSB = 1.5 LSB*/
#define Volume_ADC_SAR_CAP_TRIM_4             (0x04u)    /*decrease by 4*0.5 LSB = 2 LSB*/
#define Volume_ADC_SAR_CAP_TRIM_5             (0x05u)    /*decrease by 5*0.5 LSB = 2.5 LSB*/
#define Volume_ADC_SAR_CAP_TRIM_6             (0x06u)    /*decrease by 6*0.5 LSB = 3 LSB*/
#define Volume_ADC_SAR_CAP_TRIM_7             (0x07u)    /*decrease by 7*0.5 LSB = 3.5 LSB*/

#define Volume_ADC_SAR_TRIMUNIT               (0x08u)    /*Increase by 6fF*/
...
#define Volume_ADC_ICONT_FULL_CURRENT         (0x00u)
...
#define Volume_ADC_SAR_SOF_STOP_CONV          (0x00u)            /* Disable conversion */
...
#define Volume_ADC_SAR_SAMPLE_WIDTH           (Volume_ADC_SAMPLE_PRECHARGE - 0x02u)
...
#define Volume_ADC_SAR_PWR_CTRL_VCM_1         (0x10u)
#define Volume_ADC_SAR_PWR_CTRL_VCM_2         (0x20u)
#define Volume_ADC_SAR_PWR_CTRL_VCM_3         (0x30u)
...
#define Volume_ADC_SAR_PWR_CTRL_VREF_DIV_BY2  (0x04u)
#define Volume_ADC_SAR_PWR_CTRL_VREF_DIV_BY3  (0x08u)
#define Volume_ADC_SAR_PWR_CTRL_VREF_DIV_BY4  (0x0Cu)
...
#define Volume_ADC_SAR_OVERRUN_DET_EN_EN      (0x80u)

/* Bit Field  SAR_DLY_INC_ENUM */
#define Volume_ADC_SAR_DLY_INC                (0x40u)

/* Bit Field  SAR_DCEN_ENUM */
#define Volume_ADC_SAR_DCEN                   (0x20u)
...
#define Volume_ADC_SAR_SEL_CSEL_DFT_CHAR      (0x03u)

/*******************************************************/
/* SAR.CSR6 Satatus and Control Register 6 definitions */
/*******************************************************/
#define Volume_ADC_INT_VREF                   (0x18u)
#define Volume_ADC_INT_BYPASS_EXT_VREF        (0x04u)
#define Volume_ADC_VDDA_VREF                  (0x80u)
...
/***********************************************/
#define Volume_ADC_SAR_WRK_MAX                (0xFFFu)
#define Volume_ADC_SAR_DIFF_SHIFT             (0x800u)

/* Absolute maximum counts equivalent reference voltage */
#define Volume_ADC_SAR_WRK_MAX_12BIT          (0x00001000Lu)
#define Volume_ADC_SAR_WRK_MAX_10BIT          (0x00000400Lu)
#define Volume_ADC_SAR_WRK_MAX_8BIT           (0x00000100Lu)
