...
extern void Volume_ADC_AMux_Set(uint8 channel);
extern void Volume_ADC_AMux_Unset(uint8 channel);
/* Volume_ADC_AMux__addrTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern uint8 CYXDATA * const CYCODE Volume_ADC_AMux__addrTable[2];
/* Volume_ADC_AMux__maskTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern const uint8 CYCODE Volume_ADC_AMux__maskTable[2];
