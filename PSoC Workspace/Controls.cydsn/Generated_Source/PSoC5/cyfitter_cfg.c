...
#define BS_IDMUX_IRQ_VAL ((const uint8 CYFAR *)0x48000208u)
...
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x48000218u)
...
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x4800023Cu)

/* IOPINS0_3 Address: CYREG_PRT3_DR Size (bytes): 10 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000244u)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG1_CFG0), 0x009Fu);
