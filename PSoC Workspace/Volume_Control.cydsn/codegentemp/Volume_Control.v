// ======================================================================
// Volume_Control.v generated from TopDesign.cysch
// 11/16/2016 at 12:46
...
module top ;
    ...
    Timer_v2_70_0 ADC_Timer (
        ...
        .tc(Net_13),
        .clock(Net_87));
    defparam ADC_Timer.CaptureCount = 2;
    defparam ADC_Timer.CaptureCounterEnabled = 0;
    defparam ADC_Timer.DeviceFamily = "PSoC5";
    defparam ADC_Timer.InterruptOnCapture = 0;
    defparam ADC_Timer.InterruptOnTC = 0;
    defparam ADC_Timer.Resolution = 8;
    defparam ADC_Timer.SiliconRevision = "0";
	...
	wire [0:0] tmpOE__Volume_Messung1_net;
	wire [0:0] tmpFB_0__Volume_Messung1_net;
	wire [0:0] tmpIO_0__Volume_Messung1_net;
	wire [0:0] tmpINTERRUPT_0__Volume_Messung1_net;
	electrical [0:0] tmpSIOVREF__Volume_Messung1_net;

	cy_psoc3_pins_v1_10
		#(.id("323094b5-0178-4780-934b-e651227706c7"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Volume_Messung1
		 (.oe(tmpOE__Volume_Messung1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Volume_Messung1_net[0:0]}),
		  .analog({Net_191}),
		  .io({tmpIO_0__Volume_Messung1_net[0:0]}),
		  .siovref(tmpSIOVREF__Volume_Messung1_net),
		  .interrupt({tmpINTERRUPT_0__Volume_Messung1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Volume_Messung1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyControlReg_v1_80 Volume_Control (
        .control_1(Net_224),
        .control_2(Net_234),
        .control_3(Net_235),
        .control_0(Net_227),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Volume_Control.Bit0Mode = 0;
    defparam Volume_Control.Bit1Mode = 0;
    defparam Volume_Control.Bit2Mode = 0;
    defparam Volume_Control.Bit3Mode = 0;
    defparam Volume_Control.Bit4Mode = 0;
    defparam Volume_Control.Bit5Mode = 0;
    defparam Volume_Control.Bit6Mode = 0;
    defparam Volume_Control.Bit7Mode = 0;
    defparam Volume_Control.BitValue = 0;
    defparam Volume_Control.BusDisplay = 0;
    defparam Volume_Control.ExtrReset = 0;
    defparam Volume_Control.NumOutputs = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("54a4d1d5-1dbd-4c7a-8db2-659c48431d83"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Volume_0_net;
	wire [0:0] tmpFB_0__Volume_0_net;
	wire [0:0] tmpIO_0__Volume_0_net;
	wire [0:0] tmpINTERRUPT_0__Volume_0_net;
	electrical [0:0] tmpSIOVREF__Volume_0_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Volume_0
		 (.oe(tmpOE__Volume_0_net),
		  .y({Net_227}),
		  .fb({tmpFB_0__Volume_0_net[0:0]}),
		  .io({tmpIO_0__Volume_0_net[0:0]}),
		  .siovref(tmpSIOVREF__Volume_0_net),
		  .interrupt({tmpINTERRUPT_0__Volume_0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Volume_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Volume_Messung2_net;
	wire [0:0] tmpFB_0__Volume_Messung2_net;
	wire [0:0] tmpIO_0__Volume_Messung2_net;
	wire [0:0] tmpINTERRUPT_0__Volume_Messung2_net;
	electrical [0:0] tmpSIOVREF__Volume_Messung2_net;

	cy_psoc3_pins_v1_10
		#(.id("29d867fe-023a-4626-bb14-1cf3299a5b2d"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Volume_Messung2
		 (.oe(tmpOE__Volume_Messung2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Volume_Messung2_net[0:0]}),
		  .analog({Net_192}),
		  .io({tmpIO_0__Volume_Messung2_net[0:0]}),
		  .siovref(tmpSIOVREF__Volume_Messung2_net),
		  .interrupt({tmpINTERRUPT_0__Volume_Messung2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Volume_Messung2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
