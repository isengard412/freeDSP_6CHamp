...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG1_CFG0), 0x03A9u);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT0_AG, 0x30u);
...
void cyfitter_cfg(void)
{
	...
	static const uint8 CYCODE BS_IOPINS0_0_VAL[] = {
		0x00u, 0x03u, 0x03u, 0x00u, 0x03u, 0x00u, 0x30u, 0x00u};
...

	{
		static const uint32 CYCODE cy_cfg_addr_table[] = {
			...
			0x40010A21u, /* Base address: 0x40010A00 Count: 33 */
			0x40010B15u, /* Base address: 0x40010B00 Count: 21 */
